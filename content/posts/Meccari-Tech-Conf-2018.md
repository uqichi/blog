...
資料はこちら: https://speakerdeck.com/mercari　スライドの一枚目が全部同じで見辛いw
...
starter-kit as templateってのを用意してるらしく、一瞬でプロジェクトを始められるそう。deployに関してもterraform同様の形で、kubernates v2 providerを使って infra as code 進めているらしい。現在のデプロイにはSpinnakerを利用とのこと。
